...
/**
 * Validação em francês.
 *
 * As traduções padrão da comunidade (laravel-lang), copiadas para aqui em
 * vez de instalar o pacote inteiro: são ficheiros estáveis, e este alojamento
 * agradece cada dependência que não se acrescenta.
 */
return [
    ...
    'required_if_accepted' => 'Le champ :attribute est obligatoire quand le champ :other est accepté.',
