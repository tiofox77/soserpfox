...
<head>
    ...
    <title>Convite Cancelado - {{ config('app.name') }}</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
</head>
<body class="bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
            <div class="bg-gradient-to-r from-gray-600 to-gray-800 text-white p-6 text-center">
                <i class="fas fa-ban text-5xl mb-3"></i>
                <h2 class="text-2xl font-bold">Convite Cancelado</h2>
            </div>

            <div class="p-6 text-center">
                <p class="text-gray-600 mb-4">
                    Este convite foi cancelado e não está mais disponível.
                </p>

                <div class="bg-gray-50 border-2 border-gray-200 rounded-xl p-4 mb-6 text-left">
                ...
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 text-left text-sm text-blue-800 mb-6">
                    ...
                    <p>Se você acredita que isso foi um erro, entre em contato com <strong>{{ $invitation->invitedBy->name }}</strong>.</p>
                </div>
