...
<body class="bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
            <div class="bg-gradient-to-r from-red-600 to-orange-600 text-white p-6 text-center">
                <i class="fas fa-clock text-5xl mb-3"></i>
                <h2 class="text-2xl font-bold">Convite Expirado</h2>
            </div>

            <div class="p-6 text-center">
                <p class="text-gray-600 mb-4">
                    Infelizmente, este convite expirou em {{ $invitation->expires_at->format('d/m/Y') }}.
                </p>

                <div class="bg-orange-50 border-2 border-orange-200 rounded-xl p-4 mb-6 text-left">
                ...
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 text-left text-sm text-blue-800 mb-6">
                    ...
                    <p>Entre em contato com <strong>{{ $invitation->invitedBy->name }}</strong> para solicitar um novo convite.</p>
                </div>
