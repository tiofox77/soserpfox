    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        <div class="bg-white rounded-2xl shadow-lg p-6 border border-green-100 card-hover">
            <div class="flex items-center justify-between mb-4">
                <div class="w-14 h-14 bg-gradient-to-br from-green-500 to-teal-600 rounded-2xl flex items-center justify-center shadow-lg shadow-green-500/50">
                    <i class="fas fa-file-alt text-white text-2xl"></i>
                </div>
            </div>
            <p class="text-sm text-green-600 font-semibold mb-2">Tipos de Relatórios</p>
            <p class="text-4xl font-bold text-gray-900 mb-1">5</p>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 border border-blue-100 card-hover">
            ...
            <p class="text-4xl font-bold text-gray-900 mb-1">
                @if($reportType === 'services' && isset($reportData))
                    {{ count($reportData) }}
                @else
                    -
                @endif
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 border border-yellow-100 card-hover">
            ...
            <p class="text-sm text-yellow-600 font-semibold mb-2">Período</p>
            <p class="text-4xl font-bold text-gray-900 mb-1">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 border border-purple-100 card-hover">
            ...
            <p class="text-sm text-purple-600 font-semibold mb-2">Exportação</p>
            <p class="text-4xl font-bold text-gray-900 mb-1">2</p>
            <p class="text-xs text-gray-500">Formatos (PDF/Excel)</p>
        </div>
    </div>
