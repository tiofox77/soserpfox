            ...
            <div class="bg-white px-6 pt-6 pb-4">
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                        ...
                        <div class="mt-3">
                            <p class="text-sm text-gray-600 mb-3">Tem certeza que deseja excluir a categoria:</p>
                            ...
                            <p class="text-sm text-orange-600 font-semibold mt-3 flex items-center">
                                <i class="fas fa-info-circle mr-2"></i>
                                Categorias com serviços não podem ser excluídas!
                            </p>
                        </div>
                    </div>
                </div>
