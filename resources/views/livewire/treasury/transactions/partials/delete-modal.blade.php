<!-- Modal Confirmar Eliminação de Transação -->
@if($showDeleteModal)
<div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm animate-fadeIn" wire:click="closeDeleteModal">
    <div class="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full mx-4 transform transition-all animate-scaleIn" wire:click.stop>
        ...
        <p class="text-gray-600 text-center mb-6">
            Tem certeza que deseja eliminar a transação <span class="font-bold text-red-600">{{ $transactionToDeleteNumber }}</span>?
        </p>
        ...
        <div class="bg-red-50 border-l-4 border-red-500 p-4 mb-6 rounded-lg">
            <div class="flex">
                ...
                <div>
                    ...
                    <p class="text-sm text-red-600 mt-1">Esta ação não pode ser revertida e afetará os saldos das contas/caixas.</p>
                </div>
            </div>
        </div>
