<!-- Modal Confirmar Eliminação de Caixa -->
@if($showDeleteModal)
<div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm animate-fadeIn" wire:click="closeDeleteModal">
    <div class="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full mx-4 transform transition-all animate-scaleIn" wire:click.stop>
        ...
        <p class="text-gray-600 text-center mb-6">
            Tem certeza que deseja eliminar o caixa <span class="font-bold text-red-600">{{ $cashRegisterToDeleteName }}</span>?
        </p>
        ...
        <div class="bg-red-50 border-l-4 border-red-500 p-4 mb-6 rounded-lg">
            <div class="flex">
                ...
                <div>
                    ...
                    <p class="text-sm text-red-600 mt-1">Esta ação não pode ser revertida e todos os movimentos associados serão afetados.</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex space-x-3">
            ...
            <button type="button" wire:click="deleteCashRegister"
