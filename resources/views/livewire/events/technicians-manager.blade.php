<div class="p-4 sm:p-6">
    ...
    {{-- Modal de Importação de Funcionários de RH --}}
    @if($showImportModal)
                ...
                <div class="bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-5 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-purple-100 text-sm">Selecione os funcionários que deseja adicionar como técnicos</p>
                        </div>
                    </div>
                        ...
                        <div class="bg-purple-50 border-l-4 border-purple-500 p-4 mb-6 rounded-lg">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-purple-700">Os funcionários selecionados serão copiados para a área de técnicos de eventos com nível "Pleno" e especialidade baseada no cargo.</p>
                                </div>
                            </div>
                        </div>
