<div>
    <!-- Header -->
    <div class="mb-4 sm:mb-6 bg-gradient-to-r from-pink-600 to-rose-600 rounded-2xl shadow-lg p-4 sm:p-6 text-white">
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div class="divide-y divide-gray-100">
            @forelse($brands as $brand)
                <div class="group grid grid-cols-12 gap-4 px-4 sm:px-6 py-3 sm:py-4 hover:bg-pink-50 transition-all duration-300 items-center min-w-[500px]">
                    <!-- Marca -->
