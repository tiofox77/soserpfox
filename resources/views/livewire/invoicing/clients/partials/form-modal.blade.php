                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                                <i class="fas fa-user-tag text-green-500 mr-2"></i>Tipo *
                            </label>
                        ...
                        <div>
                            ...
                            <div class="flex space-x-2">
                                <input wire:model="nif" type="text" placeholder="Ex: 5000000000" class="flex-1 px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                                <button type="button" wire:click="lookupNIF" class="px-4 py-2.5 bg-blue-500 hover:bg-blue-600 text-white rounded-xl transition flex items-center font-semibold shadow-md" title="Buscar dados do NIF">
                                    <i class="fas fa-search mr-2"></i>Buscar
                                </button>
                            </div>
                            <p class="text-xs text-gray-500 mt-1">Digite o NIF e clique em "Buscar" para preencher automaticamente</p>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                                <i class="fas fa-globe text-blue-500 mr-2"></i>País * <span class="text-xs text-gray-500">(ISO 3166-1-alpha-2)</span>
                            </label>
