<div class="p-6 max-w-5xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Facturação Electrónica AGT</h1>
                    <p class="text-sm text-gray-500">Configure os dados do contribuinte para comunicar documentos fiscais à AGT.</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('invoicing.agt-settings') }}" class="text-xs px-3 py-2 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-700 inline-flex items-center gap-2">
                    <i class="fas fa-cogs"></i> Operação AGT (séries · submissões · logs)
                </a>
            </div>
            @endif
        </div>
    ...
    <div class="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-2xl p-4 border border-gray-200 flex items-center gap-3">
            ...
            <div>
                <p class="text-xs text-gray-500 uppercase font-bold">Acesso API</p>
        ...
        <div class="bg-white rounded-2xl p-4 border border-gray-200 flex items-center gap-3">
            ...
            <div>
                <p class="text-xs text-gray-500 uppercase font-bold">Chave RSA</p>
        ...
        <div class="bg-white rounded-2xl p-4 border border-gray-200 flex items-center gap-3">
            ...
            <div>
                <p class="text-xs text-gray-500 uppercase font-bold">Ambiente</p>
        ...
        <div class="bg-white rounded-2xl p-4 border border-gray-200 flex items-center gap-3">
            ...
            <div>
                <p class="text-xs text-gray-500 uppercase font-bold">Auto-submissão</p>
    ...
    <div class="mb-6 bg-red-50 border border-red-200 rounded-xl p-4">
        <div class="flex items-start gap-3">
            ...
            <div class="text-xs text-red-800 space-y-1">
                <p><strong>Credenciais do produtor não configuradas.</strong> O administrador do sistema precisa configurar as credenciais Basic Auth (username/password) em <strong>Operação AGT → Configurações</strong> para que a comunicação com a API AGT funcione.</p>
                <p>Estas credenciais são globais do <strong>produtor de software</strong> — não do contribuinte.</p>
            </div>
        </div>
    </div>
    @endif
    ...
    <div class="mb-6 bg-blue-50 border border-blue-200 rounded-xl p-4">
        <div class="flex items-start gap-3">
            ...
            <div class="text-xs text-blue-800 space-y-1">
                <p><strong>O que configurar aqui:</strong> O NIF do contribuinte, o código do estabelecimento e a <strong>chave privada RSA</strong> emitida pela AGT no <a href="https://portaldoparceiro.minfin.gov.ao/" target="_blank" class="underline font-bold">Portal do Contribuinte</a>.</p>
                <p>A chave RSA é usada para assinar cada documento (<code>jwsDocumentSignature</code>) e cada requisição (<code>jwsSignature</code>). Os dados do software e as credenciais de acesso à API são <strong>globais</strong> e geridos pelo administrador.</p>
            </div>
        </div>
    </div>
    ...
    <form wire:submit.prevent="save" class="bg-white rounded-2xl shadow border border-gray-200 p-6 space-y-6">
        ...
        <div>
            <h3 class="text-sm font-bold text-gray-800 mb-3 flex items-center gap-2">
                <i class="fas fa-building text-emerald-500"></i> Dados do Contribuinte
            </h3>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    <label class="block text-xs font-semibold text-gray-600 mb-1">NIF (taxRegistrationNumber) *</label>
                    <input type="text" wire:model="tax_registration_number" placeholder="Ex.: 5001636863" maxlength="15"
                    ...
                    <p class="text-[11px] text-gray-400 mt-1">Número fiscal do contribuinte (máx. 15 dígitos). Deve estar registado e ter aderido à facturação electrónica no portal AGT.</p>
                </div>
                <div>
                    <label class="block text-xs font-semibold text-gray-600 mb-1">Estabelecimento *</label>
                    ...
                    <p class="text-[11px] text-gray-400 mt-1">Código do estabelecimento registado no Portal do Contribuinte. Use "SEDE" se tiver apenas uma localização.</p>
                </div>
                <div class="md:col-span-2">
                    <label class="block text-xs font-semibold text-gray-600 mb-1">
                        Código CAE — Actividade Económica
                        <span class="text-[10px] font-normal text-gray-400">(DS.120 §4.1)</span>
                    </label>
                    <select wire:model.defer="agt_eac_code"
                        class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-200 outline-none text-sm">
                        <option value="">— Seleccione a actividade principal —</option>
                        @php
                    ...
                    <p class="text-[11px] text-gray-400 mt-1">
                        Obrigatório nas submissões à AGT. Lista oficial de classificação de actividades.
                    </p>
                    @error('agt_eac_code')
                ...
                <div>
                    <label class="block text-xs font-semibold text-gray-600 mb-1">Ambiente AGT</label>
        ...
        <div>
            <h3 class="text-sm font-bold text-gray-800 mb-3 flex items-center gap-2">
                ...
                @if($hasPrivateKey)
                    <span class="text-[10px] text-green-700 bg-green-100 px-2 py-0.5 rounded-full">instalada</span>
                @endif
            </h3>
            <div class="bg-amber-50 border border-amber-200 rounded-lg p-3 mb-4">
                <p class="text-xs text-amber-800">
                    <i class="fas fa-exclamation-triangle mr-1"></i>
                    Esta chave é <strong>gerada e emitida pela AGT</strong> e está disponível no
                    <a href="https://portaldoparceiro.minfin.gov.ao/" target="_blank" class="underline font-bold">Portal do Contribuinte</a>.
                    É utilizada para assinar digitalmente cada documento (<code>jwsDocumentSignature</code>) e cada requisição (<code>jwsSignature</code>).
                    <strong>Nunca partilhe esta chave.</strong>
                </p>
            </div>
            ...
            @if($hasPrivateKey)
                <div class="flex items-center gap-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <span class="text-sm text-green-800 font-medium">Chave privada RSA instalada com sucesso.</span>
            ...
            @else
                <div>
                    <label class="block text-xs font-semibold text-gray-600 mb-1">Cole a chave privada PEM aqui:</label>
                    ...
                    <p class="text-[11px] text-gray-400 mt-1">Formato PEM, RSA mínimo 2048 bits. Armazenada localmente no servidor (não na BD).</p>
                </div>
            @endif
        </div>
        ...
        <div>
            <h3 class="text-sm font-bold text-gray-800 mb-3 flex items-center gap-2">
                <i class="fas fa-sliders-h text-emerald-500"></i> Comportamento
            </h3>
            <div class="space-y-3">
                <label class="flex items-start gap-3 cursor-pointer">
                    ...
                    <div>
                        <p class="text-sm font-semibold text-gray-700">Submissão automática à AGT</p>
                        <p class="text-xs text-gray-500">Cada documento fiscal criado (FT/FR/NC/ND) é enviado automaticamente para a AGT após gravação.</p>
                    </div>
                </label>
                <label class="flex items-start gap-3 cursor-pointer">
                    ...
                    <div>
                        <p class="text-sm font-semibold text-gray-700">Exigir validação prévia</p>
                        <p class="text-xs text-gray-500">Bloqueia emissão se o documento não cumprir as regras de conformidade AGT v1.2.</p>
                    </div>
                </label>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-5 border border-amber-200">
            <h3 class="font-bold text-amber-900 mb-3 flex items-center gap-2">
                <i class="fas fa-envelope-open-text text-amber-600"></i> Notificações de erros AGT
            </h3>
            <p class="text-xs text-amber-800/80 mb-3">
                Lista de emails (separados por vírgula) que recebem notificação quando uma submissão à AGT
                é <strong>rejeitada</strong> (resultCode 2) ou contém <strong>erros parciais</strong> (resultCode 1).
                Se vazio, é usado o fallback dos utilizadores com permissão <code class="bg-amber-100 px-1 rounded">invoicing.agt.view</code>.
            </p>
            <label class="block text-xs font-semibold text-gray-700 mb-1">Emails (CSV)</label>
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="text-sm">
                    @if($connectionTest['success'] ?? false)
                        <strong>Conexão OK.</strong> {{ $connectionTest['message'] ?? 'Credenciais e configuração validadas.' }}
                    @else
                        <strong>Falhou.</strong> {{ $connectionTest['error'] ?? 'Erro desconhecido' }}
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="mt-6 bg-gray-50 rounded-2xl border border-gray-200 p-5">
        <h3 class="text-sm font-bold text-gray-700 mb-3 flex items-center gap-2">
            <i class="fas fa-sitemap text-gray-500"></i> Arquitectura de Chaves e Assinaturas AGT
        </h3>
        <div class="overflow-x-auto">
            <table class="w-full text-xs">
                <thead>
                    <tr class="bg-gray-100">
                        <th class="text-left px-3 py-2 font-bold text-gray-600">Assinatura</th>
                        <th class="text-left px-3 py-2 font-bold text-gray-600">Chave utilizada</th>
                        <th class="text-left px-3 py-2 font-bold text-gray-600">Quem fornece</th>
                        <th class="text-center px-3 py-2 font-bold text-gray-600">Escopo</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                    <tr>
                        <td class="px-3 py-2 font-mono text-gray-700">jwsSoftwareSignature</td>
                        <td class="px-3 py-2 text-gray-600">Chave RSA do <strong>produtor</strong></td>
                        <td class="px-3 py-2 text-gray-600">SOS ERP (administrador)</td>
                        <td class="px-3 py-2 text-center"><span class="px-2 py-0.5 rounded-full bg-purple-100 text-purple-700 font-bold">Global</span></td>
                    </tr>
                    <tr>
                        <td class="px-3 py-2 font-mono text-gray-700">jwsDocumentSignature</td>
                        <td class="px-3 py-2 text-gray-600">Chave RSA do <strong>contribuinte</strong></td>
                        <td class="px-3 py-2 text-gray-600">Portal do Contribuinte AGT</td>
                        <td class="px-3 py-2 text-center"><span class="px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-700 font-bold">Por tenant</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="px-3 py-2 font-mono text-gray-700">Basic Auth</td>
                        <td class="px-3 py-2 text-gray-600">Username + Password</td>
                        <td class="px-3 py-2 text-gray-600">AGT → Produtor de Software</td>
                        <td class="px-3 py-2 text-center"><span class="px-2 py-0.5 rounded-full bg-purple-100 text-purple-700 font-bold">Global</span></td>
                    </tr>
                </tbody>
            </table>
