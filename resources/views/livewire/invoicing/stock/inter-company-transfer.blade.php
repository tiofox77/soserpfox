            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-center text-xs font-bold text-gray-700 uppercase">Saldo</th>
                        ...
                        <td class="px-6 py-4 text-center whitespace-nowrap">
                            @if($transfer->batch_reference)
                                ...
                                <a href="{{ route('invoicing.stock.batch-pdf', ['reference' => $transfer->batch_reference]) }}"
                                   target="_blank" rel="noopener" title="Descarregar PDF"
                        ...
                        @foreach($transferItems as $index => $item)
                            <div wire:key="linha-{{ $item['product_id'] ?? 'x' . $index }}"
                                ...
                                <div class="text-right mr-4">
                                    <label class="block text-xs text-gray-500 mb-1" for="qtd-ic-{{ $index }}">Quantidade</label>
            ...
            <div class="p-6 space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="text-center p-4 rounded-xl bg-red-50 border-2 border-red-200">
                        <p class="text-xs text-gray-600 uppercase">Esta empresa (saída)</p>
                        ...
                        <table class="min-w-full text-sm">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th colspan="2" class="px-3 py-2 text-center text-xs font-bold text-red-700 uppercase border-l">Esta empresa</th>
                ...
                <p class="text-[11px] text-gray-400 text-center">
                    ...
                    Documento interno de conferência — não é documento fiscal e não substitui
                    factura nem guia de transporte.
                </p>
            </div>
