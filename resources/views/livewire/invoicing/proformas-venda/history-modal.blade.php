    ...
    <div class="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div class="bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-4 rounded-t-2xl flex items-center justify-between">
            <div>
                ...
                <p class="text-purple-100 text-sm mt-1">{{ __('Proforma: :numero', ['numero' => $proformaHistory->proforma_number]) }}</p>
            </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <span class="inline-flex px-3 py-1 text-xs font-bold rounded-full
                            ...
                            {{ $proformaHistory->status === 'draft' ? __('Rascunho') : '' }}
                            {{ $proformaHistory->status === 'sent' ? __('Enviada') : '' }}
                            {{ $proformaHistory->status === 'accepted' ? __('Aceite') : '' }}
                        </span>
                    </div>
                </div>
            </div>
