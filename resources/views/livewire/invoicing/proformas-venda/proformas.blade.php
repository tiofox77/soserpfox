<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Orçamentos e propostas comerciais</p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        <div class="bg-gradient-to-br from-purple-500 to-indigo-600 rounded-xl shadow-lg p-4 text-white">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-purple-200 text-xs font-medium">Total</p>
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center animate-pulse">
                                ...
                                <p class="text-gray-400 text-sm mt-2">Crie a sua primeira proforma de venda</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
