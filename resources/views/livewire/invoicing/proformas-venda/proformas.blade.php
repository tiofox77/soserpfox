    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('invoicing.sales.proformas.create') }}" 
               class="px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-xl font-bold transition shadow-lg transform hover:scale-105">
