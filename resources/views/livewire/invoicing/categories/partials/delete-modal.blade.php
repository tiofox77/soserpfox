        ...
        <div class="p-6">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-red-800 text-sm mb-3">
                                Você está prestes a eliminar permanentemente a categoria:
                            </p>
                ...
                <div class="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-4">
                    ...
                    <ul class="space-y-2 text-sm text-yellow-800">
                        <li class="flex items-start">
                            ...
                            <span><strong>Dados da categoria</strong></span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-exclamation-triangle text-yellow-500 mr-2 mt-0.5"></i>
                            <span><strong>Produtos associados</strong> ficarão sem categoria</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-exclamation-triangle text-yellow-500 mr-2 mt-0.5"></i>
                            <span><strong>Subcategorias</strong> (se houver) também serão removidas</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bg-blue-50 border-2 border-blue-200 rounded-xl p-4 mb-6">
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-blue-800">
                        <strong>Nota:</strong> A categoria será removida de todos os produtos. Os produtos continuarão a existir sem categoria.
                    </div>
                </div>
            </div>
            ...
            <div class="flex space-x-3">
                ...
                <button type="button" wire:click="deleteCategory"
                    ...
                    <i class="fas fa-trash-alt mr-2"></i>Sim, Eliminar Categoria
                </button>
            </div>
        </div>
    </div>
