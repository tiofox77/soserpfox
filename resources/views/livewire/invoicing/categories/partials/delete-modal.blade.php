<!-- Modal Confirmar Eliminação de Categoria -->
@if($showDeleteModal)
        ...
        <div class="p-6">
            <div class="mb-6">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-red-800 text-sm mb-3">
                                {{ __('Você está prestes a eliminar permanentemente a categoria:') }}
                            </p>
                            <div class="bg-white rounded-lg p-3 mb-3">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-900">{{ $categoryToDeleteName }}</p>
                ...
                <div class="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-4">
                    <h4 class="font-bold text-yellow-900 mb-3 flex items-center">
                        ...
                        {{ __('O que será afetado:') }}
                    </h4>
                    <ul class="space-y-2 text-sm text-yellow-800">
                        <li class="flex items-start">
                            <i class="fas fa-times-circle text-red-500 mr-2 mt-0.5"></i>
                            <span><strong>{{ __('Dados da categoria') }}</strong></span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-exclamation-triangle text-yellow-500 mr-2 mt-0.5"></i>
                            <span>{!! __('<strong>Produtos associados</strong> ficarão sem categoria') !!}</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-exclamation-triangle text-yellow-500 mr-2 mt-0.5"></i>
                            <span>{!! __('<strong>Subcategorias</strong> (se houver) também serão removidas') !!}</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bg-blue-50 border-2 border-blue-200 rounded-xl p-4 mb-6">
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-blue-800">
                        <strong>{{ __('Nota:') }}</strong> {{ __('A categoria será removida de todos os produtos. Os produtos continuarão a existir sem categoria.') }}
                    </div>
                </div>
            </div>
            ...
            <div class="flex space-x-3">
                ...
                <button type="button" wire:click="deleteCategory"
                    ...
                    <i class="fas fa-trash-alt mr-2"></i>{{ __('Sim, Eliminar Categoria') }}
                </button>
            </div>
        </div>
    </div>
