<div>
    <div class="mb-6 bg-gradient-to-r from-slate-700 to-gray-800 rounded-2xl shadow-lg p-5 text-white flex items-center justify-between">
        <div class="flex items-center">
            ...
            <div><h2 class="text-2xl font-bold">Mapa de Documentos</h2><p class="text-gray-200 text-sm">Resumo consolidado de documentos emitidos</p></div>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        @foreach($rows as $r)
            <div class="bg-white rounded-2xl shadow-md p-5 border-l-4 border-{{ $r['color'] }}-500 hover:shadow-xl transition">
                ...
                <p class="text-sm text-gray-500 mt-1">Total movimentado</p>
    ...
    <div class="mt-6 bg-white rounded-2xl shadow-lg overflow-hidden">
        <div class="px-5 py-3 bg-gray-50 border-b">
            <h3 class="font-bold text-gray-800"><i class="fas fa-table mr-2 text-slate-600"></i>Resumo Tabular</h3>
        </div>
        <table class="w-full text-sm">
            <thead class="bg-gray-50 text-xs uppercase text-gray-600">
                <tr>
                    <th class="px-3 py-2 text-left">Tipo de Documento</th>
                    <th class="px-3 py-2 text-right">Quantidade</th>
                    <th class="px-3 py-2 text-right">Valor Total (Kz)</th>
                </tr>
            </thead>
