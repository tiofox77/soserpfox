<div>
    <div class="mb-6 bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl shadow-lg p-5 text-white flex items-center justify-between">
        <div class="flex items-center">
            ...
            <div><h2 class="text-2xl font-bold">Top Produtos Vendidos</h2><p class="text-purple-100 text-sm">Produtos com maior volume e receita</p></div>
        </div>
    ...
    <div class="grid grid-cols-2 gap-3 mb-6">
        <div class="bg-white rounded-xl shadow p-4 border-l-4 border-purple-500"><p class="text-xs font-bold text-purple-600 uppercase">Qtd Total</p><p class="text-2xl font-bold mt-1">{{ number_format($grandQty, 2, ',', '.') }}</p></div>
        <div class="bg-white rounded-xl shadow p-4 border-l-4 border-pink-500"><p class="text-xs font-bold text-pink-600 uppercase">Valor Total</p><p class="text-2xl font-bold mt-1 text-pink-700">{{ number_format($grandValue, 2, ',', '.') }} Kz</p></div>
    </div>
