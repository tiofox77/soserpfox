<div>
    <div class="mb-6 bg-gradient-to-r from-yellow-500 to-amber-600 rounded-2xl shadow-lg p-5 text-white flex items-center justify-between">
        <div class="flex items-center">
            ...
            <div><h2 class="text-2xl font-bold">Top Clientes</h2><p class="text-yellow-100 text-sm">Ranking de clientes por faturação</p></div>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        <div class="px-5 py-3 bg-gradient-to-r from-yellow-50 to-amber-50 border-b">
            <h3 class="font-bold text-gray-800"><i class="fas fa-trophy mr-2 text-amber-600"></i>Ranking — Total faturado: <span class="text-amber-700">{{ number_format($grandTotal, 2, ',', '.') }} Kz</span></h3>
        </div>
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 text-xs uppercase text-gray-600">
                    <tr>
                        ...
                        <th class="px-3 py-2 text-right">Faturado</th>
