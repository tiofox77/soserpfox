<!-- Modal Confirmar Eliminação de Fornecedor -->
@if($showDeleteModal)
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-red-800 text-sm mb-3">
                                {{ __('Você está prestes a eliminar permanentemente o fornecedor:') }}
                            </p>
                            <div class="bg-white rounded-lg p-3 mb-3">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-900">{{ $supplierToDeleteName }}</p>
                ...
                <div class="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-4">
                    ...
                    <ul class="space-y-2 text-sm text-yellow-800">
                        <li class="flex items-start">
                            ...
                            <span><strong>{{ __('Dados do fornecedor') }}</strong></span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-times-circle text-red-500 mr-2 mt-0.5"></i>
                            <span><strong>{{ __('Contactos e endereços') }}</strong></span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-times-circle text-red-500 mr-2 mt-0.5"></i>
                            <span><strong>{{ __('Histórico de compras') }}</strong></span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bg-blue-50 border-2 border-blue-200 rounded-xl p-4 mb-6">
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-blue-800">
                        <strong>{{ __('Nota:') }}</strong> {{ __('Se este fornecedor tiver produtos ou compras associadas, a eliminação pode ser bloqueada.') }}
                    </div>
                </div>
            </div>
