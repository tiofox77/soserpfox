    ...
    <div class="mb-6 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl shadow-lg p-6 text-white">
        <div class="flex items-center justify-between">
            ...
            <button wire:click="create"
                    ...
                    class="bg-white text-blue-600 hover:bg-blue-50 px-6 py-3 rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 disabled:cursor-not-allowed">
                <span wire:loading.remove wire:target="create"><i class="fas fa-plus mr-2"></i>Nova Fatura</span>
                <span wire:loading wire:target="create"><i class="fas fa-spinner fa-spin mr-2"></i>Carregando...</span>
            </button>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div class="md:col-span-2">
                ...
                <div class="relative">
                    ...
                    <input wire:model.live.debounce.300ms="search" type="text" placeholder="Número fatura, cliente, NIF..." 
