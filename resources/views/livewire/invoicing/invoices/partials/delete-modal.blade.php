<!-- Modal Confirmar Eliminação de Fatura -->
@if($showDeleteModal)
            ...
            <div class="mb-6">
                <div class="bg-red-50 border-2 border-red-200 rounded-xl p-4 mb-4">
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            <h3 class="text-lg font-bold text-red-900 mb-2">⚠️ ATENÇÃO - Ação Crítica!</h3>
                            <p class="text-red-800 text-sm mb-3">
                                Você está prestes a eliminar permanentemente a fatura:
                            </p>
                            <div class="bg-white rounded-lg p-3 mb-3">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-900">{{ $invoiceToDeleteNumber }}</p>
                ...
                <div class="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-4">
                    ...
                    <ul class="space-y-2 text-sm text-yellow-800">
                        <li class="flex items-start">
                            ...
                            <span><strong>Fatura e todos os itens</strong></span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-times-circle text-red-500 mr-2 mt-0.5"></i>
                            <span><strong>Pagamentos associados</strong></span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-times-circle text-red-500 mr-2 mt-0.5"></i>
                            <span><strong>Movimentações de stock</strong></span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-times-circle text-red-500 mr-2 mt-0.5"></i>
                            <span><strong>Histórico de alterações</strong></span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bg-red-50 border-2 border-red-200 rounded-xl p-4 mb-6">
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-red-800">
                        <strong>⚠️ AVISO LEGAL:</strong> Eliminar faturas pode violar regulamentos fiscais. Certifique-se de ter autorização legal antes de prosseguir.
                    </div>
                </div>
            </div>
