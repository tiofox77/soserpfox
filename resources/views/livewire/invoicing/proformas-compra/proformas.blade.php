        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-3xl font-bold text-gray-800 flex items-center">
                    ...
                    {{ __('Proformas de Compra') }}
                </h2>
                <p class="text-gray-600 mt-1">{{ __('Orçamentos e propostas de fornecedores') }}</p>
            </div>
                    ...
                    <tr class="hover:bg-orange-50 transition-all duration-200">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <x-pdf-descarregar :url="route('invoicing.purchases.proformas.preview', $proforma->id)" />
                                
                                {{-- Duplicar: aproveita o conteúdo, nunca a identidade
                                     do documento (número, série, hash, datas, estado).
                                     Ver o trait DuplicaDocumento. --}}
                                <a href="{{ route('invoicing.purchases.proformas.create', ['duplicar' => $proforma->id]) }}"
