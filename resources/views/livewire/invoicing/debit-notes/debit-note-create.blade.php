    ...
    <div class="mb-6 bg-gradient-to-r from-red-600 to-rose-600 rounded-2xl shadow-lg p-6 text-white">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-3xl font-bold">Nova Nota de Débito</h2>
                    <p class="text-red-100 text-sm mt-1">Juros, multas e cobranças adicionais</p>
                </div>
            </div>
            <a href="{{ route('invoicing.debit-notes.index') }}" 
               class="bg-white text-red-600 hover:bg-red-50 px-6 py-3 rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-green-600 mt-1 font-semibold"><i class="fas fa-magic mr-1"></i>Os produtos da fatura serão carregados automaticamente!</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <select wire:model="reason" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500">
                            ...
                            <option value="penalty">⚠️ Multa</option>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-600 mb-2 uppercase tracking-wider">
                            <i class="fas fa-calendar-check mr-1 text-red-600"></i>Data de Vencimento
                        </label>
            ...
            <div class="p-6">
                ...
                @else
                    <div class="p-12 text-center">
                        ...
                        <p class="text-gray-400 text-sm mt-2">Clique em "Adicionar" para começar</p>
                    </div>
                @endif
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-red-100 overflow-hidden">
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="flex gap-4 pt-4 border-t-2">
                    ...
                    <button type="submit" 
                            class="flex-1 px-6 py-4 bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-800 text-white rounded-xl font-bold transition-all shadow-lg">
                        <i class="fas fa-save mr-2"></i>Criar Nota de Débito
                    </button>
                </div>
            </div>
        </div>
