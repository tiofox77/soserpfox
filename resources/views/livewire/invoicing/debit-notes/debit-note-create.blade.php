        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-green-100 text-sm mt-1">Juros, multas e cobranças adicionais</p>
                </div>
            </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-red-600 mt-1 font-semibold"><i class="fas fa-magic mr-1"></i>Os produtos da fatura serão carregados automaticamente!</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-600 mb-2 uppercase tracking-wider">
                            <i class="fas fa-calendar-check mr-1 text-green-600"></i>Data de Vencimento
                        </label>
