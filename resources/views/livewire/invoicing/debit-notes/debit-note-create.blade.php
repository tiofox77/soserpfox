    ...
    <div class="mb-6 bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl shadow-lg p-6 text-white">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-3xl font-bold">{{ __('Nova Nota de Débito') }}</h2>
                    <p class="text-green-100 text-sm mt-1">{{ __('Juros, multas e cobranças adicionais') }}</p>
                </div>
            </div>
    ...
    <form wire:submit.prevent="save">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-green-100 overflow-hidden card-hover mb-6">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        <label class="block text-xs font-bold text-gray-600 mb-2 uppercase tracking-wider">
                            <i class="fas fa-calendar mr-1 text-green-600"></i>{{ __('Data de Emissão') }} *
                        </label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-600 mb-2 uppercase tracking-wider">
                            <i class="fas fa-file-invoice mr-1 text-green-600"></i>{{ __('Fatura Original (opcional)') }}
                        </label>
                        ...
                        <p class="text-xs text-red-600 mt-1 font-semibold"><i class="fas fa-magic mr-1"></i>{{ __('Os produtos da fatura serão carregados automaticamente!') }}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <select wire:model="reason" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500">
                            ...
                            <option value="penalty">⚠️ {{ __('Multa') }}</option>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-600 mb-2 uppercase tracking-wider">
                            <i class="fas fa-calendar-check mr-1 text-green-600"></i>{{ __('Data de Vencimento') }}
                        </label>
                ...
                <div>
                    <label class="block text-xs font-bold text-gray-600 mb-2 uppercase tracking-wider">
                        <i class="fas fa-comment mr-1 text-green-600"></i>{{ __('Observações') }}
                    </label>
            ...
            <div class="p-6">
                ...
                @else
                    <div class="p-12 text-center">
                        ...
                        <p class="text-gray-400 text-sm mt-2">{{ __('Clique em "Adicionar" para começar') }}</p>
                    </div>
                @endif
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-green-100 overflow-hidden">
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="flex justify-between text-sm">
                    <span class="text-gray-600">{{ __('IVA (14%):') }}</span>
                ...
                <div class="flex gap-4 pt-4 border-t-2">
                    ...
                    <button type="submit"
                            class="flex-1 px-6 py-4 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-800 text-white rounded-xl font-bold transition-all shadow-lg">
                        <i class="fas fa-save mr-2"></i>{{ __('Criar Nota de Débito') }}
                    </button>
                </div>
            </div>
        </div>
