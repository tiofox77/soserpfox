{{-- Modal Backdrop --}}
<div wire:key="hr-leave-approval-modal" class="fixed inset-0 bg-gray-900 bg-opacity-50 z-50 flex items-center justify-center p-4"
     ...
     @click.self="$wire.set('showApprovalModal', false)">
    ...
    <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full"
        ...
        <div class="bg-gradient-to-r from-red-600 to-pink-600 px-6 py-4 flex items-center justify-between rounded-t-2xl">
            ...
            <button wire:click="$set('showApprovalModal', false)" class="text-white hover:text-gray-200 transition-colors">
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-red-700">
                                Esta ação rejeitará a solicitação de licença. Por favor, forneça um motivo para a rejeição.
                            </p>
                        </div>
                    </div>
                </div>
