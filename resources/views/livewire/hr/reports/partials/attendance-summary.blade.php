    ...
    <table class="w-full text-sm">
        <thead>
            <tr class="bg-gray-50 text-gray-700">
                ...
                <th class="px-4 py-3 text-center font-bold text-green-600"><i class="fas fa-check mr-1"></i>Presenças</th>
        ...
        <tbody>
            ...
            <tr class="border-b border-gray-100 hover:bg-gray-50 transition">
                ...
                <td class="px-4 py-2 text-center"><span class="px-2 py-1 bg-green-100 text-green-700 rounded-full text-xs font-bold">{{ $row['present'] }}</span></td>
                ...
                <td class="px-4 py-2 text-center">
                    <div class="flex items-center justify-center gap-2">
                        ...
                        <span class="text-xs font-bold {{ $rate >= 90 ? 'text-green-700' : ($rate >= 70 ? 'text-yellow-700' : 'text-red-700') }}">{{ $rate }}%</span>
                    </div>
                </td>
            </tr>
            @endforeach
