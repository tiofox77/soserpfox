...
<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4">
        <div class="px-6 py-4 bg-gradient-to-r from-red-600 to-orange-600 flex items-center justify-between rounded-t-xl">
            <h2 class="text-xl font-bold text-white flex items-center">
                <i class="fas fa-lock mr-2"></i>
                Fechar Período
            </h2>
            <button wire:click="$set('showCloseModal', false)" class="text-white hover:text-gray-200">
        ...
        <div class="p-6">
                    ...
                    <div class="flex">
                        ...
                        <div class="text-sm text-yellow-800">
                            ...
                            <ul class="list-disc list-inside space-y-1">
                                <li>Não será possível criar novos lançamentos</li>
                                <li>Lançamentos existentes não poderão ser editados</li>
                                <li>Você pode reabrir o período se necessário</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex gap-3">
                ...
                <button type="button" 
                    ...
                    <i class="fas fa-lock mr-2"></i>Sim, Fechar
                </button>
            </div>
        </div>
    </div>
