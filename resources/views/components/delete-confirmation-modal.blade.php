@props(['show' => 'showDeleteModal', 'itemName' => '', 'icon' => 'fa-exclamation-triangle', 'entityType' => 'item'])
            ...
            <div class="bg-white px-6 pt-6 pb-4">
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mx-auto flex-shrink-0 flex items-center justify-center h-16 w-16 rounded-full bg-red-100 sm:mx-0 sm:h-14 sm:w-14 animate-pulse">
                        <i class="fas {{ $icon }} text-red-600 text-2xl"></i>
                    </div>
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                        ...
                        <div class="mt-3">
                            <p class="text-sm text-gray-600 mb-3">
                                Tem certeza que deseja excluir {{ $entityType }}:
                            </p>
                            <div class="p-4 bg-red-50 rounded-xl border-2 border-red-200">
                                <p class="font-bold text-gray-900 text-center break-words">
                                    {{ $itemName }}
                                </p>
                            </div>
