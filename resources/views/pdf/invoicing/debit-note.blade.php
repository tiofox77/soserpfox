    ...
    <div class="page-wrapper">
        ...
        <div class="footer-section">
                        ...
                        <table class="tax-table">
                            ...
                            <tbody>
                                <tr>
                                    <td>IVA</td>
                                    <td>14%</td>
                                    <td class="currency">{{ number_format($debitNote->subtotal, 2, ',', '.') }}</td>
                                    <td class="currency">{{ number_format($debitNote->tax_amount, 2, ',', '.') }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="agt-description">
                Esta nota de débito foi processada pelo Sistema de Facturação | Regime: {{ $tenant->regime ?? 'Regime Geral' }}
            </div>
