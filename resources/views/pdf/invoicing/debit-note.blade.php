...
<body>
    ...
    <div class="page-wrapper">
        @include('pdf.invoicing.partials.agt-signature-sidebar', ['document' => $debitNote, 'documentLabel' => 'Nota de Débito SOS ERP'])
        <div class="main-content">
            <div class="header-section">
                ...
                <div class="right-section">
                    <div class="supplier-info">
                        ...
                        <div class="supplier-name">{{ $debitNote->client->name }}</div>
                        <div class="supplier-nif">NIF: {{ $debitNote->client->nif ?? 'N/D' }}</div>
            ...
            <div class="doc-header">
                <div class="doc-title" style="text-align: left;">Nota de Débito n.º {{ $debitNote->debit_note_number }}</div>
                @if($debitNote->invoice)
                <div style="font-size: 9px; color: #666; margin-top: 5px; text-align: left;">
                    Referente à Fatura: {{ $debitNote->invoice->invoice_number }} ({{ $debitNote->invoice->invoice_date->format('d/m/Y') }})
                </div>
                @endif
            </div>
        ...
        <div class="footer-section">
                ...
                <div class="left-bottom">
                    <div class="tax-section">
                        ...
                        <table class="tax-table">
                            ...
                            @include("pdf.invoicing.partials.tax-summary", ["doc" => $debitNote])
                        </table>
                    </div>
                    ...
                    <div class="system-info">
                        ...
                        @if($debitNote->hash)
                            <br>
                            <strong>HASH e SAFT-AO:</strong> "{{ substr($debitNote->hash, -4) }}"
                        @endif
                    </div>
                </div>
                ...
                <div class="right-bottom">
                    <div class="summary-section">
                        <div class="summary-row">
                            ...
                            <span>{{ number_format($debitNote->subtotal, 2, ',', '.') }}</span>
                        </div>
                        <div class="summary-row">
                        ...
                        <div class="summary-row">
                            <span>IVA</span>
                            <span>{{ number_format($debitNote->tax_amount, 2, ',', '.') }}</span>
                        </div>
                        <div class="summary-row">
                            <span>Total da ND</span>
                            <span>{{ number_format($debitNote->total, 2, ',', '.') }}</span>
                        </div>
                        <div class="summary-row">
                            <span>Retenção</span>
                            <span>0,00</span>
            ...
            <div class="agt-description">
                Esta nota de débito foi processada pelo Sistema de Facturação | Regime: {{ method_exists($tenant, "regimeLabel") ? $tenant->regimeLabel() : ($tenant->regime ?? "Regime Geral") }}
            </div>
