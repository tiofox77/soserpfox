...
<head>
    ...
    <title>Fatura de Compra {{ $invoice->invoice_number }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="page-wrapper">
        @include('pdf.invoicing.partials.agt-signature-sidebar', ['document' => $invoice, 'documentLabel' => 'Fatura Compra SOS ERP'])
        <div class="main-content">
            <div class="header-section">
                ...
                <div class="right-section">
                    <div class="supplier-info">
                        <div class="supplier-label">Fornecedor</div>
                        <div class="supplier-name">{{ $invoice->supplier->name }}</div>
                        <div class="supplier-nif">NIF: {{ $invoice->supplier->nif ?? 'N/D' }}</div>
            ...
            <div class="doc-header">
                <div class="doc-title" style="text-align: left;">Fatura de Compra n.º {{ $invoice->invoice_number }}</div>
            </div>
