...
<body>
    ...
    <div class="page-wrapper">
        @include('pdf.invoicing.partials.agt-signature-sidebar', ['document' => $advance, 'documentLabel' => 'Adiantamento SOS ERP'])
        ...
        <div class="footer-section">
            ...
            <div class="agt-description">
                Este adiantamento foi processado pelo Sistema de Facturação | Regime: {{ method_exists($tenant, "regimeLabel") ? $tenant->regimeLabel() : ($tenant->regime ?? "Regime Geral") }}
            </div>
