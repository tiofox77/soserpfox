...
<head>
    ...
    <title>Proforma de Compra {{ $proforma->proforma_number }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="page-wrapper">
        <div class="main-content">
            ...
            @endif
                ...
                <div class="right-section">
                    <div class="supplier-info">
                        ...
                        <div class="supplier-name">{{ $proforma->supplier->name }}</div>
                        <div class="supplier-nif">NIF: {{ $proforma->supplier->nif ?? 'N/D' }}</div>
            ...
            <div class="doc-header">
                <div class="doc-title" style="text-align: left;">Proforma de Compra n.º {{ $proforma->proforma_number }}</div>
            </div>
