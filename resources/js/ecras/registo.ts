...
export const ecras: Record<string, Ecra> = {
    ...
    'cliente/extrato': () =>
        import('./cliente/Extrato'),
    'cliente/eventos': () =>
        import('./cliente/Eventos'),
    'cliente/facturas': () =>
        import('./cliente/Facturas'),
    'cliente/proformas': () =>
        import('./cliente/Proformas'),
    'cliente/perfil': () =>
    ...
    'oficina/indicadores': () =>
        import('./oficina/Indicadores'),
    'oficina/cortesia': () =>
        import('./oficina/Cortesia'),
    'oficina/frotas': () =>
        import('./oficina/Frotas'),
    'oficina/recomendacoes': () =>
        import('./oficina/Recomendacoes'),
    'oficina/lembretes': () =>
        import('./oficina/Lembretes'),
    'oficina/pacotes': () =>
        import('./oficina/Pacotes'),
    ...
    'plataforma/contactos': () =>
        import('./plataforma/Contactos'),
    'plataforma/estabelecimentos': () =>
        import('./plataforma/Estabelecimentos'),
    'plataforma/registo-de-emails': () =>
        import('./plataforma/RegistoDeEmails'),
    'plataforma/aparelhos-pwa': () =>
        import('./plataforma/AparelhosPwa'),
    'plataforma/modelos-de-email': () =>
        import('./plataforma/ModelosDeEmail'),
    'plataforma/avisos': () =>
