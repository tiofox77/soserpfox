            ...
            {id !== null && ficha.isPending ? (
                ...
                <div className="space-y-5">
                    ...
                    <fieldset className="grid gap-4 sm:grid-cols-2">
                        ...
                        <Campo etiqueta={t('NIF')} erro={erros.nif} ajuda={t('Da empresa: começa por 5, ou dez dígitos começados por 0. De empresário em nome individual: o número do BI (nove dígitos, duas letras, três dígitos).')}>
