...
export const transferencias = {
    ...
    historico: (f: { procura?: string; armazem?: string; de?: string; ate?: string; page?: number }) => api.ler<Pagina<LoteDoHistorico>>('/transferencias/historico', f),
    detalhes: (f: { referencia?: string | null; reference_id?: number | null }) => api.ler<{ data: LinhaDoLote[] }>('/transferencias/detalhes', { referencia: f.referencia ?? undefined, reference_id: f.reference_id ?? undefined }),
