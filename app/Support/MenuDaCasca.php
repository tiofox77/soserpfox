    ...
    private static function grupos(): array
    {
        return [
            ...
            [
                ...
                'entradas' => [
                    ['rota' => 'events.dashboard', 'rotulo' => 'Dashboard', 'icone' => 'fa-chart-pie', 'cor' => 'blue-400', 'activo' => 'events.dashboard'],
                    ['rota' => 'events.calendar', 'rotulo' => 'Calendário', 'icone' => 'fa-calendar-alt', 'cor' => 'indigo-400', 'activo' => 'events.calendar'],
                    ['rota' => 'events.reports', 'rotulo' => 'Relatórios', 'icone' => 'fa-chart-bar', 'cor' => 'purple-400', 'activo' => 'events.reports'],
                    ['rota' => 'events.equipment.index', 'rotulo' => 'Equipamentos', 'icone' => 'fa-tools', 'cor' => 'purple-400', 'activo' => 'events.equipment.*'],
                    ['rota' => 'events.venues.index', 'rotulo' => 'Locais', 'icone' => 'fa-map-marker-alt', 'cor' => 'red-400', 'activo' => 'events.venues.*'],
                    ['rota' => 'events.types.index', 'rotulo' => 'Tipos de Eventos', 'icone' => 'fa-tags', 'cor' => 'yellow-400', 'activo' => 'events.types.*'],
                    ['rota' => 'events.technicians.index', 'rotulo' => 'Técnicos', 'icone' => 'fa-user-tie', 'cor' => 'cyan-400', 'activo' => 'events.technicians.*'],
                ],
            ],
            ...
            [
                ...
                'entradas' => [
                    ['rota' => 'accounting.dashboard', 'rotulo' => 'Dashboard', 'icone' => 'fa-chart-pie', 'cor' => 'emerald-400', 'activo' => 'accounting.dashboard'],
                    ['separador' => true],
                    ['rota' => 'accounting.accounts', 'rotulo' => 'Plano de Contas', 'icone' => 'fa-sitemap', 'cor' => 'purple-400', 'activo' => 'accounting.accounts*'],
                    ['rota' => 'accounting.journals', 'rotulo' => 'Diários', 'icone' => 'fa-book', 'cor' => 'blue-400', 'activo' => 'accounting.journals*'],
                    ['rota' => 'accounting.document-types', 'rotulo' => 'Tipos de Documentos', 'icone' => 'fa-file-alt', 'cor' => 'purple-400', 'activo' => 'accounting.document-types*'],
                    ['rota' => 'accounting.moves', 'rotulo' => 'Lançamentos', 'icone' => 'fa-file-invoice', 'cor' => 'green-400', 'activo' => 'accounting.moves*'],
                    ['rota' => 'accounting.periods', 'rotulo' => 'Períodos', 'icone' => 'fa-calendar-alt', 'cor' => 'yellow-400', 'activo' => 'accounting.periods*'],
                    ['separador' => true],
                    ['rota' => 'accounting.reports', 'rotulo' => 'Relatórios', 'icone' => 'fa-chart-bar', 'cor' => 'cyan-400', 'activo' => 'accounting.reports*'],
                    ['separador' => true],
                    ['rota' => 'accounting.reconciliation', 'rotulo' => 'Reconciliação', 'icone' => 'fa-exchange-alt', 'cor' => 'blue-400', 'activo' => 'accounting.reconciliation*'],
                    ['rota' => 'accounting.fixed-assets', 'rotulo' => 'Imobilizado', 'icone' => 'fa-building', 'cor' => 'purple-400', 'activo' => 'accounting.fixed-assets*'],
                    ['rota' => 'accounting.currencies', 'rotulo' => 'Moedas', 'icone' => 'fa-coins', 'cor' => 'green-400', 'activo' => 'accounting.currencies*'],
                    ['rota' => 'accounting.cost-centers', 'rotulo' => 'Centros Custo', 'icone' => 'fa-sitemap', 'cor' => 'orange-400', 'activo' => 'accounting.cost-centers*'],
                    ['rota' => 'accounting.analytics', 'rotulo' => 'Analítica', 'icone' => 'fa-chart-pie', 'cor' => 'pink-400', 'activo' => 'accounting.analytics*'],
                    ['rota' => 'accounting.budgets', 'rotulo' => 'Orçamentos', 'icone' => 'fa-calculator', 'cor' => 'indigo-400', 'activo' => 'accounting.budgets*'],
                    ['separador' => true],
                    ['rota' => 'accounting.settings', 'rotulo' => 'Configurações', 'icone' => 'fa-cog', 'cor' => 'gray-400', 'activo' => 'accounting.settings*'],
                ],
            ],
            ...
            [
                ...
                'entradas' => [
                    ['rota' => 'workshop.dashboard', 'rotulo' => 'Dashboard', 'icone' => 'fa-chart-line', 'cor' => 'blue-400', 'activo' => 'workshop.dashboard'],
                    ['rota' => 'workshop.vehicles', 'rotulo' => 'Veículos', 'icone' => 'fa-car', 'cor' => 'blue-400', 'activo' => 'workshop.vehicles*'],
                    ['rota' => 'workshop.mechanics', 'rotulo' => 'Mecânicos', 'icone' => 'fa-user-cog', 'cor' => 'orange-400', 'activo' => 'workshop.mechanics*'],
                    ['rota' => 'workshop.services', 'rotulo' => 'Serviços', 'icone' => 'fa-tools', 'cor' => 'purple-400', 'activo' => 'workshop.services*'],
                    ['rota' => 'workshop.parts', 'rotulo' => 'Peças', 'icone' => 'fa-boxes', 'cor' => 'orange-400', 'activo' => 'workshop.parts*'],
                    ['rota' => 'workshop.work-orders', 'rotulo' => 'Ordens de Serviço', 'icone' => 'fa-clipboard-list', 'cor' => 'yellow-400', 'activo' => 'workshop.work-orders*'],
                    ['rota' => 'workshop.reports', 'rotulo' => 'Relatórios', 'icone' => 'fa-chart-bar', 'cor' => 'green-400', 'activo' => 'workshop.reports*'],
                ],
            ],
            ...
            [
                ...
                'entradas' => [
                    ['rota' => 'hotel.dashboard', 'rotulo' => 'Dashboard', 'icone' => 'fa-chart-line', 'cor' => 'blue-400', 'activo' => 'hotel.dashboard'],
                    ['rota' => 'hotel.reservations', 'rotulo' => 'Reservas', 'icone' => 'fa-calendar-check', 'cor' => 'green-400', 'activo' => 'hotel.reservations*'],
                    ['rota' => 'hotel.walk-in', 'rotulo' => 'Walk-in', 'icone' => 'fa-walking', 'cor' => 'emerald-400', 'activo' => 'hotel.walk-in*'],
                    ['rota' => 'hotel.checkout', 'rotulo' => 'Check-out', 'icone' => 'fa-sign-out-alt', 'cor' => 'red-400', 'activo' => 'hotel.checkout*'],
                    ['rota' => 'hotel.calendar', 'rotulo' => 'Calendário', 'icone' => 'fa-calendar-alt', 'cor' => 'indigo-400', 'activo' => 'hotel.calendar*'],
                    ['rota' => 'hotel.housekeeping', 'rotulo' => 'Housekeeping', 'icone' => 'fa-broom', 'cor' => 'teal-400', 'activo' => 'hotel.housekeeping*'],
                    ['rota' => 'hotel.maintenance', 'rotulo' => 'Manutenção', 'icone' => 'fa-tools', 'cor' => 'orange-400', 'activo' => 'hotel.maintenance*'],
                    ['rota' => 'hotel.staff', 'rotulo' => 'Funcionários', 'icone' => 'fa-users', 'cor' => 'cyan-400', 'activo' => 'hotel.staff*'],
                    ['rota' => 'hotel.rooms', 'rotulo' => 'Quartos', 'icone' => 'fa-door-open', 'cor' => 'orange-400', 'activo' => 'hotel.rooms*'],
                    ['rota' => 'hotel.room-types', 'rotulo' => 'Tipos de Quarto', 'icone' => 'fa-bed', 'cor' => 'purple-400', 'activo' => 'hotel.room-types*'],
                    ['rota' => 'hotel.guests', 'rotulo' => 'Hóspedes', 'icone' => 'fa-users', 'cor' => 'cyan-400', 'activo' => 'hotel.guests*'],
                    ['rota' => 'hotel.reports', 'rotulo' => 'Relatórios', 'icone' => 'fa-chart-bar', 'cor' => 'amber-400', 'activo' => 'hotel.reports*'],
                    ['rota' => 'hotel.rates', 'rotulo' => 'Tarifas', 'icone' => 'fa-tags', 'cor' => 'amber-400', 'activo' => 'hotel.rates*'],
                    ['rota' => 'hotel.packages', 'rotulo' => 'Pacotes', 'icone' => 'fa-gift', 'cor' => 'pink-400', 'activo' => 'hotel.packages*'],
                    ['rota' => 'hotel.kiandastay', 'rotulo' => 'KiandaStay', 'sem_traducao' => true, 'icone' => 'fa-link', 'cor' => 'gray-400', 'activo' => 'hotel.kiandastay*'],
                    ['rota' => 'hotel.settings', 'rotulo' => 'Configurações', 'icone' => 'fa-cog', 'cor' => 'gray-400', 'activo' => 'hotel.settings*'],
                ],
            ],
            ...
            [
                ...
                'entradas' => [
                    ['rota' => 'salon.dashboard', 'rotulo' => 'Dashboard', 'icone' => 'fa-chart-line', 'cor' => 'blue-400', 'activo' => 'salon.dashboard'],
                    ['rota' => 'salon.appointments', 'rotulo' => 'Agendamentos', 'icone' => 'fa-calendar-check', 'cor' => 'green-400', 'activo' => 'salon.appointments*'],
                    ['rota' => 'salon.clients', 'rotulo' => 'Clientes', 'icone' => 'fa-users', 'cor' => 'cyan-400', 'activo' => 'salon.clients*'],
                    ['rota' => 'salon.services', 'rotulo' => 'Serviços', 'icone' => 'fa-cut', 'cor' => 'purple-400', 'activo' => 'salon.services'],
                    ['rota' => 'salon.services.categories', 'rotulo' => 'Categorias', 'icone' => 'fa-folder', 'cor' => 'pink-300', 'activo' => 'salon.services.categories'],
                    ['rota' => 'salon.professionals', 'rotulo' => 'Profissionais', 'icone' => 'fa-user-tie', 'cor' => 'orange-400', 'activo' => 'salon.professionals*'],
                    ['rota' => 'salon.products', 'rotulo' => 'Produtos', 'icone' => 'fa-boxes', 'cor' => 'emerald-400', 'activo' => 'salon.products*'],
                    ['rota' => 'salon.pos', 'rotulo' => 'POS / Faturar', 'icone' => 'fa-cash-register', 'cor' => 'yellow-400', 'activo' => 'salon.pos*'],
                    ['rota' => 'salon.reports.time', 'rotulo' => 'Relatórios', 'icone' => 'fa-chart-bar', 'cor' => 'cyan-400', 'activo' => 'salon.reports.*'],
                    ['separador' => true],
                    ['rota' => 'salon.settings', 'rotulo' => 'Configurações', 'icone' => 'fa-cog', 'cor' => 'gray-400', 'activo' => 'salon.settings'],
                ],
            ],
            ...
            [
                ...
                'entradas' => [
                    ...
                    ['rota' => 'restaurant.products', 'rotulo' => 'Produtos e Menu', 'icone' => 'fa-bowl-food', 'cor' => 'amber-300', 'activo' => 'restaurant.products', 'permissao' => 'restaurant.orders.view'],
                    ['rota' => 'restaurant.carta', 'rotulo' => 'Montar o Menu', 'icone' => 'fa-book-open-reader', 'cor' => 'pink-300', 'activo' => ['restaurant.carta', 'restaurant.categories'], 'permissao' => 'restaurant.orders.view'],
