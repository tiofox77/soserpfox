...
{
    protected $table = 'invoicing_sales_quote_items';
    ...
    public function calculateTotals()
    {
        ...
        // O IVA incide sobre o líquido ACRESCIDO do IEC, como na factura e na
        // proforma. Sem isto a linha apurava o IVA só sobre o líquido e ficava
        // a divergir do cabeçalho. O Imposto de Selo não entra.
        $iec = 0.0;
        if ($this->exists) {
