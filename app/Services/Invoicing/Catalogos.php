    ...
    private static function viaturas(): array
    {
        return [
            ...
            'grupos' => [
                ...
                // OF-11: a próxima revisão (marca-se sozinha ao concluir uma ordem) e o intervalo desta viatura.
                ['chave' => 'manutencao', 'rotulo' => 'Manutenção', 'icone' => 'fa-oil-can', 'campos' => ['next_service_km', 'next_service_date', 'service_interval_km', 'service_interval_months', 'last_service_km', 'last_service_date']],
            ],
            ...
            'campos' => [
                ...
                self::campo('next_service_km', 'Próxima revisão (km)', 'numero', passo: 1, min: 0, ajuda: 'Marca-se sozinha quando uma ordem desta viatura fica concluída.'),
                self::campo('next_service_date', 'Próxima revisão (data)', 'data', ajuda: 'A que chegar primeiro — os km ou a data — põe a viatura nos Lembretes.'),
                self::campo('service_interval_km', 'Revisão a cada (km)', 'numero', passo: 500, min: 0, ajuda: 'Vazio = o intervalo da oficina (definições dos Lembretes).'),
                self::campo('service_interval_months', 'Revisão a cada (meses)', 'numero', passo: 1, min: 0, max: 60, ajuda: 'Vazio = o intervalo da oficina.'),
                self::campo('last_service_km', 'Última revisão (km)', 'numero', passo: 1, min: 0),
                self::campo('last_service_date', 'Última revisão (data)', 'data'),
                self::campo('notes', 'Notas', 'textarea', largura: 'inteira'),
            ],
            'regras' => [
                ...
                'next_service_km' => 'nullable|integer|min:0|max:5000000',
                'next_service_date' => 'nullable|date',
                'service_interval_km' => 'nullable|integer|min:0|max:200000',
                'service_interval_months' => 'nullable|integer|min:0|max:60',
                'last_service_km' => 'nullable|integer|min:0|max:5000000',
            ...
            'preparar' => fn (array $d) => array_merge($d, [
                ...
                'next_service_km' => ($d['next_service_km'] ?? '') === '' || ($d['next_service_km'] ?? null) === null ? null : (int) $d['next_service_km'],
                'next_service_date' => ($d['next_service_date'] ?? '') ?: null,
                'service_interval_km' => ($d['service_interval_km'] ?? '') === '' || ($d['service_interval_km'] ?? null) === null ? null : (int) $d['service_interval_km'],
                'service_interval_months' => ($d['service_interval_months'] ?? '') === '' || ($d['service_interval_months'] ?? null) === null ? null : (int) $d['service_interval_months'],
                'last_service_km' => ($d['last_service_km'] ?? '') === '' || ($d['last_service_km'] ?? null) === null ? null : (int) $d['last_service_km'],
