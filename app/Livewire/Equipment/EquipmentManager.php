...
class EquipmentManager extends Component
{
    ...
    public $categories = [
        ...
        'video' => '📹 Vídeo e Streaming',
        'estruturas' => '🏗️ Estruturas e Palco',
        'energia' => '⚡ Energia e Geradores',
    ...
    public function render()
    {
        $equipment = Equipment::where('tenant_id', activeTenantId())
            ...
            ->with(['borrowedToClient', 'createdBy'])
        ...
        return view('livewire.equipment.equipment-manager', compact('equipment', 'stats', 'clients', 'locations', 'alerts'));
    }
